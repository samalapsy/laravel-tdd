...
<div class="w-2/3 bg-gray-200 mx-auto p-6 shadow">
    ...
    <form method="post" action="{{ route('authors.store') }}" class="flex flex-col items-center">
        @csrf
        ...
        <div class="pt-4">
        <button class="bg-blue-400 tex-white rounded py-2 px-4"> Add New Author</button>
        </div>
    </form>
</div>
